...
/* package HaskImageTool-0.1.0.0 */
#ifndef VERSION_HaskImageTool
#define VERSION_HaskImageTool "0.1.0.0"
#endif /* VERSION_HaskImageTool */
#ifndef MIN_VERSION_HaskImageTool
#define MIN_VERSION_HaskImageTool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskImageTool */
...
#define CURRENT_COMPONENT_ID "HaskImageTool-0.1.0.0-inplace-HaskImageTool"
